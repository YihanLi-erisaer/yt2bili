...
只支持一条链接。稿件按**转载**提交，简介末尾会带上原标题、原作者和原链接。
...
| 版权 | 转载，来源为 YouTube 原链接 | 固定，不提供改成自制的开关 |
| 分辨率 | yt-dlp 能下到的最高画质，再转成 H.264 + AAC 的 MP4 | 无上限；4K 转码会比较慢 |
| 时长 | 不限制 | — |
